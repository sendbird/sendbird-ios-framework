...
/// The `SBDApplicationUserListQuery` class is a query class for getting the list of all users of the current
/// application. This instance is created by `createApplicationUserListQuery` of `SBDMain`.
/// @since 3.0.120
...
/// This has to be set by `setMetaDataFilterWithKey:values:`.
